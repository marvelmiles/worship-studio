...
export const THEMES: Theme[] = [
  ...
  { id: "celebration", name: "Celebration", builtIn: true, fontFamily: "Montserrat", fontWeight: 800, color: "#fffaf0", align: "center", lineHeight: 1.15, letterSpacing: 0.5, fontSize: 5.4, uppercase: true, textShadow: "0 3px 28px rgba(0,0,0,0.5)", backgroundId: "bg-celebration", animation: "zoom" },
  { id: "scripture", name: "Scripture", builtIn: true, fontFamily: "Cormorant Garamond", fontWeight: 600, color: "#f6f1e4", align: "center", lineHeight: 1.32, letterSpacing: 0.2, fontSize: 4.4, uppercase: false, textShadow: "0 2px 20px rgba(0,0,0,0.6)", backgroundId: "bg-royal", animation: "fade" },
];
